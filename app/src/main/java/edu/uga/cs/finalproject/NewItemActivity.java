...
public class NewItemActivity extends AppCompatActivity {
    ...
    private void saveItem(){
        ...
        CollectionReference ref = FirebaseFirestore.getInstance().collection("ItemList");
        ref.document(itemTitle).set(new GroceryItem(itemTitle, description, priority, grocerySelected));
